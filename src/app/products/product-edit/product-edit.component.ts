...
export class ProductEditComponent implements OnInit {
 ...
 /*  product: Product; */ // change this to getter and setter
   get isDirty(): boolean {
  ...
  set product(value: Product) {
    ...
    //clone the obj to retain a copy 
...
ngOnInit():void {
 ...
 const resolvedData : ProductResolved = data['resolvedData'];/* this.route.snapshot.data['resolvedData']; */
...
this.reset();
  ...
  validate () : void {
    // clear the validation error each time
    this.dataIsValid = {};
